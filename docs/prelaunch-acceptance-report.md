...
- 生成时间：2026-06-11 21:24:24
- 总体结果：需处理
- 硬性失败：0
- 预警：2
- 当前运行环境：development
- 生产模式：否
- 本次发布版本：2026.06.11.local
- 部署命令清单：docs\deployment-runbook-2026.06.11.local.md

## 结论说明

- 当前报告运行在非生产环境，剩余待处理项：完整上线门禁、生产环境标记；正式上线前必须在生产环境完成这些项目并重新执行 `prelaunch_report --strict`。
...
| 说明 | 最近门禁通过，生成于 2026-06-11 21:24:02 |
...
| 附件安全扫描 | OK | 通过 | 未配置扫描命令，已由 本地预上线验证 接受风险 |
...
| 最近后台任务 | JOB202606110019 / process_pending_events / 成功 / 2026-06-11 21:24:13 |
| 失败后台任务 | 0 |
| 待处理事务后事件 | 0 |
| 失败事务后事件 | 0 |
| 最近发布记录 | 2026.06.11.local / 2026-06-11 16:42:26 |

## 运维证据验收

| 检查项 | 级别 | 结果 | 说明 |
| --- | --- | --- | --- |
| 部署命令清单 | OK | 通过 | D:\XC\2026\ERP\docs\deployment-runbook-2026.06.11.local.md |
...
| 事务后事件处理 | OK | 通过 | JOB202606110019 / process_pending_events / 成功 / 2026-06-11 21:24:13 |
| 发布记录 | OK | 通过 | 2026.06.11.local / 2026-06-11 16:42:26 |
