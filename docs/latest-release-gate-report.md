...
| URL 引用完整性检查 | OK | URL 引用检查通过：678 个静态引用，682 个 URL 名称，279 个模板参数引用 | `D:\XC\2026\ERP\.venv\Scripts\python.exe D:\XC\2026\ERP\manage.py check_url_references` |
...
| 业务冒烟测试 | OK | 业务冒烟测试通过：tag=2026061304050385DC, operator=admin, 已回滚冒烟数据 | `D:\XC\2026\ERP\.venv\Scripts\python.exe D:\XC\2026\ERP\manage.py business_smoke_test --operator admin` |
| 完整自动测试 | OK | Ran 750 tests in 430.303s | `D:\XC\2026\ERP\.venv\Scripts\python.exe D:\XC\2026\ERP\manage.py test --noinput --verbosity 1` |
